...
{
    public partial class NovatProductPurchaseInfo : Form
    {
        DbClass db = new DbClass();
        CommonMethod cm = new CommonMethod();

        public NovatProductPurchaseInfo()
        {
            InitializeComponent();
        ...
        public void SearchList()
        {
            try
            {
                ...
                if (chkdate.Checked == true)
                {
                    ...
                    {
                        MessageBox.Show("To Date Shuld Be Greater Than From Date");
                ...
                if (chkdate.Checked == false && chkcode.Checked == false && chkcompanyname.Checked == false && chkgroupname.Checked == false && chkproductname.Checked == false && chksupplier.Checked == false)
                {
        ...
        private void btnprint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (chkproductname.Checked == true || chkgroupname.Checked == true || chkcode.Checked == true || chkcompanyname.Checked == true || chkdate.Checked == true || chksupplier.Checked == true)
                {
                    if (chkproductname.Checked == true)
                ...
                RptProductWisePurchase crpt = new RptProductWisePurchase(pname1, suppliername, mfgcompany, groupid, code, false, from1, to1, Convert.ToInt32(cmbGodownName.SelectedIndex));
                crpt.ShowDialog();
                crpt.Dispose();
            }
            catch (Exception) { }
